...
import com.onlineshop.app.app.adapters.CustomViewPagerAdapter
...
class HomeLogic : AppCompatActivity(), NavigationBarView.OnItemSelectedListener {
    ...
    private fun businessLogic() {
        ...
        val customViewPagerAdapter = CustomViewPagerAdapter(this@HomeLogic)
        pagerView.adapter = customViewPagerAdapter
        pagerView.isUserInputEnabled = false
        bottomNavView.setOnItemSelectedListener(this@HomeLogic)
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        val inflater = MenuInflater(this@HomeLogic)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.logout -> {
                ...
                startActivity(Intent(this@HomeLogic, SignInLogic::class.java))
                finish()
                true
            }
