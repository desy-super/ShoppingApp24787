...
class SignUpLogic : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(!(getSharedPreferences(packageName, Context.MODE_PRIVATE).getString("userToken","").isNullOrEmpty())){
            val intent= Intent(this@SignUpLogic,HomeLogic::class.java)
    ...
    private fun businessLogic(){
       ...
       signupButton.setOnClickListener {
           ...
           signinButton.setOnClickListener {
               startActivity(Intent(this@SignUpLogic,SignInLogic::class.java))
               finish()
           }
        ...
        WebApiClient.getWebApiInterface().signUpUser(signUpModel).enqueue(object:Callback<AppUserSignUpResponse>{
            override fun onResponse(
                ...
                if (response.code() == 200) {
                    ...
                    val intent=Intent(this@SignUpLogic,SignInLogic::class.java)
                    startActivity(intent)
                    finish()
                }
            ...
            override fun onFailure(call: Call<AppUserSignUpResponse>, t: Throwable) {
                ...
                Toast.makeText(this@SignUpLogic,"failed try again",Toast.LENGTH_LONG).show()
            }
