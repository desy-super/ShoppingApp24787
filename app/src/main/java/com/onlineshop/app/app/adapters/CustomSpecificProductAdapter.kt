...
class CustomSpecificProductAdapter(val context: Context, private val mutableList: MutableList<AppSpecificItemResponse>,
 ...
 if (dispaly.isNotEmpty() &&  context.getSharedPreferences(context.packageName,Context.MODE_PRIVATE).getBoolean("isDisplayCalled",false)){
     ...
     buy.setOnClickListener {
         ...
         val intent= Intent(context, HomeLogic::class.java)
