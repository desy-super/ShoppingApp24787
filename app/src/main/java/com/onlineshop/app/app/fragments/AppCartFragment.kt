...
import com.onlineshop.app.app.activities.HomeLogic
import com.onlineshop.app.app.adapters.CartAdapter
...
class CartFragment : Fragment(),CartInterface {
            ...
            floatingActionButton.setOnClickListener {
                ...
                alertDialog.setPositiveButton("order", DialogInterface.OnClickListener { dialogInterface, i ->
                    run {
                        ...
                        ( requireActivity() as HomeLogic).supportActionBar?.subtitle="Total Amount:".plus(sharedPreferences.getString("totalAmount","€0.0"))
    ...
    private fun  showNotification(){
        ...
        val intent= Intent(requireActivity(),HomeLogic::class.java)
